...
@Service
public class AnonymousCompany_recordsShowService implements AbstractShowService<Anonymous, Company_records> {

	@Autowired
	private AnonymousCompany_recordsRepository repository;
