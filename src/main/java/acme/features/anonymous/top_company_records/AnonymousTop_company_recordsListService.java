...
@Service
public class AnonymousTop_company_recordsListService implements AbstractListService<Anonymous, Company_records> {

	@Autowired
	AnonymousTop_company_recordsRepository repository;
