...
@Service
public class AnonymousTop_investorRecordListService implements AbstractListService<Anonymous, Investor_record> {

	// Internal state ---------------------------------------------------------

	@Autowired
	AnonymousTop_investor_recordRepository repository;
